...
public class Populator implements CommandLineRunner {
    ...
    public Populator(TopicStorage topicStorage, PostStorage postStorage,HashtagStorageJpaImpl hashtagStorage) {
    ...
    public void run(String... args) throws Exception {
       ...
       Hashtag hashtag1 = new Hashtag("#intersting",post1);
        hashtagStorage.save(hashtag1);

        Hashtag hashtag2 = new Hashtag("#java",post2);
        hashtagStorage.save(hashtag2);

        Hashtag hashtag3 = new Hashtag("#TDD",post3);
        hashtagStorage.save(hashtag3);
        Hashtag hashtag4 = new Hashtag("#POO");
        hashtagStorage.save(hashtag4);
